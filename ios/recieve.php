...
// Create connection
	$mysqli=mysqli_connect("localhost","id10018181_sagarkalyan81","sagarkalyan81","id10018181_floclu"); // localhost, user name, user password, database name
...
Failed to connect to MySQL: " . mysqli_connect_error();
	...
	$query = "insert into `example_table` (latitude, longitude, time_stamp) value ('".$latitude."','".$longitude."','".$time_stamp."')";
